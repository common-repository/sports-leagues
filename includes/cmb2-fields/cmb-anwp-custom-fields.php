<?php
/*
CMB2 Field Type: AnWP Custom Fields
Version: 0.1.0
License: GPLv2+
...
add_action( 'cmb2_render_anwp_custom_fields', 'cmb2_render_anwp_custom_fields', 10, 5 );
add_filter( 'cmb2_sanitize_anwp_custom_fields', 'cmb2_sanitize_anwp_custom_fields', 10, 2 );

if ( ! function_exists( 'cmb2_render_anwp_custom_fields' ) ) {
	 ...
	 * @return void
	 */
	function cmb2_render_anwp_custom_fields( $field, $saved_options, $field_object_id, $field_object_type, $field_type_object ) {
		...
		$options = sports_leagues()->get_option_value( $option_slug );
...
if ( ! function_exists( 'cmb2_sanitize_anwp_custom_fields' ) ) {
	 ...
	 * @return mixed
	 */
	function cmb2_sanitize_anwp_custom_fields( $null, $value ) {
