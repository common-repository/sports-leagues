<?php
/**
 * Sports Leagues :: Block > Last Game
 *
 * @package Sports_Leagues
 */

class Sports_Leagues_Block_Last_Game {
	...
	public function register_blocks() {
		register_block_type(
			Sports_Leagues::dir( 'gutenberg/blocks/last-game' ),
			[
				'title'           => 'SL Last Game',
	...
	public function server_side_render( $attr, $content, $block_instance ) {
		...
		$html_output = sports_leagues()->template->widget_loader( 'last-game', $shortcode_attr );
...
return new Sports_Leagues_Block_Last_Game();
