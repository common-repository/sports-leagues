<?php
/**
 * The Template for displaying Last Game Widget.
 *
 * This template can be overridden by copying it to yourtheme/sports-leagues/widget-last-game.php.
 *
		...
		<div class="game-widget <?php echo $transparent_bg ? '' : 'anwp-bg-light'; ?> <?php echo esc_attr( $widget_index ? 'mt-2' : '' ); ?>"
			...
			<div class="game-widget__teams d-flex mt-3 mb-1">
				...
				<div class="anwp-flex-none align-self-center d-flex game-widget__scores">
					<span class="game-widget__scores-number"><?php echo (int) $data->home_scores; ?></span>
					<span class="game-widget__scores-separator px-1 anwp-opacity-70">:</span>
					<span class="game-widget__scores-number"><?php echo (int) $data->away_scores; ?></span>
				</div>
				<div class="game-widget__team anwp-flex-1 d-flex flex-column align-items-center anwp-text-center anwp-min-width-0 px-1">
					<?php if ( Sports_Leagues::string_to_bool( $args->show_team_name ) ) : ?>
						<img loading="lazy" class="game-widget__team-logo anwp-object-contain mt-2 <?php echo $image_size_style ? '' : 'anwp-w-60 anwp-h-60'; ?>"
			...
			<?php if ( $args->game_link_text ) : ?>
				<div class="anwp-text-center anwp-game-preview-link <?php echo $transparent_bg ? '' : 'anwp-bg-light'; ?> mt-2">
